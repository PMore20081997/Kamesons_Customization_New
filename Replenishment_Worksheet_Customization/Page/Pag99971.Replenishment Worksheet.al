...
//                     L_ReplenishmentWorksheetCU: Codeunit "Replenishment Worksheet";

//                     //New++

//                     L_TempReqLine: Record "Requisition Line";
//                     L_LineNo: Integer;
...
//                     if L_ReplenishmentWorksheet.FindSet() then begin

//                         L_TempReqLine.Reset();
//                         L_TempReqLine.SetRange("Journal Batch Name", L_ReplenishmentWorksheet."Batch Name");
//                         L_TempReqLine.SetFilter("Created By Repl.", '%1', true);
//                         if not L_TempReqLine.IsEmpty then
//                             L_TempReqLine.DeleteAll();
...
//                         L_TempReqLine.SetRange("Journal Batch Name", L_ReplenishmentWorksheet."Batch Name");
//                         L_TempReqLine.SetFilter("Created By Repl.", '%1', true);
//                         if L_TempReqLine.FindSet() then begin
//                             L_ReplenishmentWorksheetCU.ProcessReqLineActions(L_TempReqLine);
//                         end;
//                     end;
